package net.mcreator.switchotscraft.block.entity;
...
public class SawblockTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(3, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public SawblockTileEntity(BlockPos pos, BlockState state) {
		super(RevampedProgressionModBlockEntities.SAWBLOCK.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<SawblockTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<SawblockTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("sawblock");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new SawblockguiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
