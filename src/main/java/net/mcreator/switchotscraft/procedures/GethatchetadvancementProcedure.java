...
public class GethatchetadvancementProcedure {
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if (!(entity instanceof ServerPlayer _plr0 && _plr0.level() instanceof ServerLevel
				&& _plr0.getAdvancements().getOrStartProgress(_plr0.server.getAdvancements().getAdvancement(new ResourceLocation("revamped_progression:thistocutsometree"))).isDone())) {
			if ((new Object() {
				...
				if (entity instanceof ServerPlayer _player) {
					Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("revamped_progression:thistocutsometree"));
