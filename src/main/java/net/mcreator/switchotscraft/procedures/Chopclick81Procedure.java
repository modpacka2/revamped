...
public class Chopclick81Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).is(ItemTags.create(new ResourceLocation("forge:axes")))) {
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == RevampedProgressionModBlocks.L_81.get()) {
				{
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == RevampedProgressionModBlocks.P_81.get()) {
				{
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockState _bs = RevampedProgressionModBlocks.CL_9.get().defaultBlockState();
					BlockState _bso = world.getBlockState(_bp);
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == RevampedProgressionModBlocks.L_181.get()) {
				{
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockState _bs = RevampedProgressionModBlocks.CL_9.get().defaultBlockState();
					BlockState _bso = world.getBlockState(_bp);
