...
public class SawblockguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SawblockguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RevampedProgressionModMenus.SAWBLOCKGUI.get(), id);
